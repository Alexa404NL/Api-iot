...
/**
  * Endpoint #1. getLogDistance
  * 
  * Este método realiza un select de todos los registros ubicados en
  * una tabla llamada "proxi".
  * 
  * Resultado: Obtendrá todos los registros de la tabla "proxi" 
...
/**
  ...
  * 
  * Este método realiza un select de todos los registros ubicados en
  * una tabla llamada "proxi" que se encuentren entre dos fechas.
  * 
  * Resultado: Obtendrá todos los registros de la tabla "proxi" 
  ...
  * Dashboards.
  */
async function getDistByDateBetween(req,res){
  try{
    var sql = constants.selectDistanceByDate;
...
/**
  ...
  * 
  * Este método realiza un insert sobre la tabla "proxi".
...
module.exports = {insertLogDistance, getLogDistancia,getDistByDateBetween};
